...
import crosscat.src.EngineTemplate as EngineTemplate
...
import crosscat.src.utils.sample_utils as su

# For `default_diagnostic_func_dict` below.
import crosscat.src.utils.diagnostic_utils
...
default_diagnostic_func_dict = {
    ...
    # imports.
    'logscore':crosscat.src.utils.diagnostic_utils.get_logscore,
    'num_views':crosscat.src.utils.diagnostic_utils.get_num_views,
    'column_crp_alpha':crosscat.src.utils.diagnostic_utils.get_column_crp_alpha,
    # Any outputs required by reproess_diagnostics_func must be generated
    # as well.
    'column_partition_assignments':
        crosscat.src.utils.diagnostic_utils.get_column_partition_assignments,
    'reprocess_diagnostics_func':
        crosscat.src.utils.diagnostic_utils.default_reprocess_diagnostics_func
}
